...
/home/ycp7/script/DTC/preQC_array.sh $batchID $rawPED > ${out_dir}/preQC.o 2> ${out_dir}/preQC.e
# Outputs:
# ${batchID}.bed .bim .fam
# ${batchID}_list.txt
# ${batchID}_chr1-22_snps.txt

echo -e "Finished preQC on: $(date)\n"
...
seq 22 | parallel -j 0 /home/ycp7/script/DTC/imputation_array.sh $batchID {} $prephased_chr_haps $(pwd) ">" chr{}.o "2>" chr{}.e
